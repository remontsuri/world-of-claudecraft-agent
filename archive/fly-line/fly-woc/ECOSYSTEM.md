...
| 7 | **Визуализация и дашборд** | [FalinX/fly-brain](https://github.com/FalinX/fly-brain) (README: MIT), [cobanov/fly-connectome-template](https://github.com/cobanov/fly-connectome-template) | MIT / **custom: кредит обязателен** | ~~three.js-облако точек~~ **закрыто 2026-09-17**: смотреть наши клетки умеет готовый Neuroglancer с официальной сценой MaleCNS, свой 3D-рендер не нужен — см. `VISUAL.md` |
