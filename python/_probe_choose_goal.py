"""Debug: after accept q_wolves, what does choose_goal see?"""
from hierarchical_env import HierarchicalWoWEnv, ACT_FORWARD, ACT_TURN_LEFT
from _legacy_scripted_executor import choose_goal
...
print("active after accept:", env._last_info.get("quests",{}).get("active"))
g = choose_goal(env._last_info)
print("choose_goal ->", g[0], "ctx:", g[1:] if len(g)>1 else "")
env.close()
