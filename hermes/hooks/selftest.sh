...
expect_block "удаление таблицы оракула заблокировано" '{"event":"pre_tool","command":"rm fly-woc/data/quest_oracle_214.json"}'
...
expect_block "feather-веса в коммит заблокированы"      '{"event":"pre_tool","command":"git add data/annotations.feather"}'
